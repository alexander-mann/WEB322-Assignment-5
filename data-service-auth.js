...
module.exports.initialize = function () {
    return new Promise(function (resolve, reject) {
        let db = mongoose.createConnection("mongodb://username:password@ds131621.mlab.com:31621/web322-a7");
                ...
                bcrypt.hash(userData.password, salt, function (err, hash) { // encrypt the password: "myPassword123"
                    if (err) {
                        ...
                        User.update({ user: userData.user },
                            ...
                            .exec()
                            .then(
                                resolve("Password changed successfully for user: " + userData.user)
                            )
                            .catch(
